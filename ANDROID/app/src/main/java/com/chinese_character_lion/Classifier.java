...
public class Classifier {
    ...
    // 여기서 모델 연결
    //private static final String MODEL_NAME = "chinese_classification_v2.tflite";
    private static final String MODEL_NAME = "chinese_character_classification_inception.tflite";
    ...
    private static final int NUM_CLASSES = 3755;
