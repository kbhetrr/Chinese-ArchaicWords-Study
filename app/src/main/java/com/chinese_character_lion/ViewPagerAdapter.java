...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        if(CH_WORD.length() == 2) {
            ...
            ch_text1.setText(ch_mean.get(0).substring(0, 1));
            ch_text2.setText(ch_mean.get(1).substring(0, 1));

            ko_mean1.setText(ch_mean.get(0).substring(2));
            ko_mean2.setText(ch_mean.get(1).substring(2));
            ...
            ch_text1.setText(ch_mean.get(0).substring(0, 1));
            ch_text2.setText(ch_mean.get(1).substring(0, 1));
            ch_text3.setText(ch_mean.get(2).substring(0, 1));

            ko_mean1.setText(ch_mean.get(0).substring(2));
            ko_mean2.setText(ch_mean.get(1).substring(2));
            ko_mean3.setText(ch_mean.get(2).substring(2));
            ...
            ch_text2.setText(ch_mean.get(1).substring(0, 1));
            ch_text3.setText(ch_mean.get(2).substring(0, 1));
            ch_text4.setText(ch_mean.get(3).substring(0, 1));

            ko_mean1.setText(ch_mean.get(0).substring(2));
            ko_mean2.setText(ch_mean.get(1).substring(2));
            ko_mean3.setText(ch_mean.get(2).substring(2));
            ko_mean4.setText(ch_mean.get(3).substring(2));
            ...
            ch_text3.setText(ch_mean.get(2).substring(0, 1));
            ch_text4.setText(ch_mean.get(3).substring(0, 1));
            ch_text5.setText(ch_mean.get(4).substring(0, 1));

            ko_mean1.setText(ch_mean.get(0).substring(2));
            ko_mean2.setText(ch_mean.get(1).substring(2));
            ko_mean3.setText(ch_mean.get(2).substring(2));
            ko_mean4.setText(ch_mean.get(3).substring(2));
            ko_mean5.setText(ch_mean.get(4).substring(2));
            ...
            ch_text4.setText(ch_mean.get(3).substring(0, 1));
            ch_text5.setText(ch_mean.get(4).substring(0, 1));
            ch_text6.setText(ch_mean.get(5).substring(0, 1));
            ...
            ko_mean4.setText(ch_mean.get(3).substring(2));
            ko_mean5.setText(ch_mean.get(4).substring(2));
            ko_mean6.setText(ch_mean.get(5).substring(2));
